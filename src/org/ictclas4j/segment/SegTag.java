...
public class SegTag {
	...
	public SegTag(int segPathCount) {
		...
		//F:/workspace/teacher/stop.txt
		coreDict = new Dictionary("D:\\android\\workspace\\teacherTe\\Data\\coreDict.dct");

		bigramDict = new Dictionary("D:\\android\\workspace\\teacherTe\\Data\\bigramDict.dct");
		personTagger = new PosTagger(Utility.TAG_TYPE.TT_PERSON, "D:\\android\\workspace\\teacherTe\\Data\\nr", coreDict);
		transPersonTagger = new PosTagger(Utility.TAG_TYPE.TT_TRANS_PERSON, "D:\\android\\workspace\\teacherTe\\Data\\tr", coreDict);
		placeTagger = new PosTagger(Utility.TAG_TYPE.TT_TRANS_PERSON, "D:\\android\\workspace\\teacherTe\\Data\\ns", coreDict);
		lexTagger = new PosTagger(Utility.TAG_TYPE.TT_NORMAL, "D:\\android\\workspace\\teacherTe\\Data\\lexical", coreDict);
	}
